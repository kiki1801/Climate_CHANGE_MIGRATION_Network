...
LibrariesVersions <- data.frame(
  LIBRARY = c("KNITR", "READXL", "DPLYR", "TIDYR", "DT", 
              ...
              "RNATURALEARTHHIRES", "LEAFLET", "PLOTLY", "GGIRAPH"),
...
# Clarification on ISO3 and M49 Codes
...
HelenaBarthMartin <- HelenaBarthMartin %>%
  mutate(ISO3 = c("MAF", "BLM", "SHN"),
         ...
         Region = c("Caribbean", "Caribbean", "Middle Africa"), 
         ISO2 = c("MF", "BL", "SH"), 
...
The Åland Islands are included in Finland in RIMS_WAB. We can remove them from 
UNSD.
...
RIMS_WAB_UNSD[which(RIMS_WAB_UNSD$Residence == "Cocos (Keeling) Islands"), "ContinentCode"] <- 142
...
## Stacked Barplots (IMS in Million)
