             ...
             tabsetPanel(
               tabPanel("Residence",
                        tags$div(
                          ...
                          uiOutput("C.birth_view_choice"),
                          uiOutput("R.birth_view_choice"),
                          tags$div(style = "height: 10px;"),
                          uiOutput("C.birth_view_region_choice"),
                          uiOutput("R.birth_view_region_choice"),
                          tags$div(style = "height: 10px;"),
                          plotlyOutput ("C.stacked_barplot_share", width = "100%", height = "400px"),
                          plotlyOutput ("R.stacked_barplot_share", width = "100%", height = "400px")
                          )
                        ),
               tabPanel("Birth",
                        tags$div(
