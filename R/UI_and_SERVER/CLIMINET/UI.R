...
ui <- fluidPage(
  ...
  tags$head(
    ...
    tags$style(
      ...
      #HOME => Overview Card => Clickable ICON
      ...
      "@media (max-width: 580px) {.tab-pane[data-value='Home'].active .bslib-grid.bslib-mb-spacing {grid-template-columns: 1fr 1fr !important;}}",
      #HOME => PARTNER(s) Card => AFFILIATION => LOGO => POSITION
      ...
      ".sort-button:active {background-color: #E6E6E6; border-color: #E6E6E6; outline: 5px auto -webkit-focus-ring-color !important; outline-color: #FFA500 !important; outline-offset: -2px !important;}", #CSS pseudo-class :active when button is clicked
      ...
      "img.ion-newspaper {margin-top: 1px !important;}",
      "svg.bi.bi-file-earmark-text {margin-top: 1px !important;}",
      "svg.bi.bi-bank {margin-top: 1px !important;}",
  ...
  page_navbar( #navbarPage()
    ...
    nav_panel(title = "Home", #tabPanel()
      ...
      ##### SECTION => OVERVIEW #####
      tags$div( #Overview => Animated (FadeIn)
        style = "text-align: center; font-size: 20px; text-decoration: underline !important; opacity: 0; animation: FadeIn 2.25s 0.75s forwards;", #TEXT => POSITION | FONT-SIZE
        tags$strong("Overview")), #TEXT => Bold
      ##### Overview Card #####
      tags$div( #Overview Card => Animated (FadeIn)
        ...
        card(
          ...
          card_body(
            ...
            HTML(
              "<p>Quantifying environmental migration, displacement, and mobility is challenging given the multiple drivers of such movement, related methodological challenges, and the lack of data collection standards.</p>
              <p>By integrating <strong>environmental data with socio-economic</strong>, political, and governance factors, the study aims to reveal how meteorological events drive migration patterns, and how <strong>neighboring countries</strong> influence these flows through geographic, economic, and cultural proximity. We propose a global framework covering over <strong>150 countries</strong> to analyze the impact of <strong>climate change on international migration</strong> from <strong>1990 to 2020</strong>.</p>
              <p style='font-weight: 600;'>Key innovations include:</p>
                <ul>
                  <li>A critique and improvement of the methods for estimating migration flows between pairs of countries proposed by <a href='https://doi.org/10.1038/s41597-019-0089-3' target='_blank'>Abel and Cohen (2019)</a>;</li>
                  <li>Integration of climatic variables in new forms (quantiles/extremiles, density function, functional curve, etc.) as covariates;</li>
                  <li>To better incorporate climate change into migration analysis, we consider fast- and slow-onset meteorological events;</li>
                  <li>Insights into the distinct migration dynamics between <strong>developed and developing countries</strong>;</li>
                  <li>A novel methodology to interpret the impact of climate change, following <a href='https://doi.org/10.1111/gean.12358' target='_blank'>Laurent et al. (2023)</a>;</li>
                  <li>A novel methodology to predict migration impacts from major socio-economic shocks and <strong>climate change scenarios</strong>, accounting for non-linear relationships in <strong>migration networks</strong> using advanced connectivity techniques.</li>
                </ul>
          ...
          fill = FALSE)), #Content => Fixed Size => !Allowed To Scroll
      ##### SECTION => PARTNER(s) #####
      tags$div( #Section => PARTNER(s) => Animated (FadeIn)
        style = "text-align: center; font-size: 20px; text-decoration: underline !important; margin-top: 10px !important; opacity: 0; animation: FadeIn 2.25s 0.75s forwards;", #TEXT => POSITION | FONT-SIZE || PADDING
        tags$strong("Partners")), #TEXT => Bold
      ##### PARTNER(s) Card(s) #####
      tags$div( #PARTNER(s) Card(s) => Animated (FadeIn)
        style = "opacity: 0; animation: FadeIn 2.25s 0.75s forwards;", #ANIMATION
        layout_column_wrap(
          ##### ANR Card #####
      ...
      tags$div( #Carousel => Animated (FadeIn)
        style = "opacity: 0; animation: FadeIn 2.25s 0.75s forwards;", #ANIMATION
    ...
    ##### PAPER(s) #####
    nav_panel(title = "Papers", #tabPanel()
        #Contains Multiple Tabs
        navset_tab( #tabsetPanel()
          #Selected Tab Panel
          selected = "Publications",
    ...
    nav_panel(title = "Presentations", #tabPanel(),
      ...
      tags$button(
        ...
        #          border: 1px solid #B9BABA;", #BORDER-WIDTH-and-COLOR
        style = "display: flex; /*FLEXBOX CONTAINER*/
                 margin-bottom: -10px; /*MARGIN(s) => BOTTOM To -10px*/
                 padding: 10px 20px; /*PADDING => Top/Bottom => 10px | LEFT/RIGHT => 20px*/
                 width: 125px; /*WIDTH To 125px*/
                 border-width: 1px; border-radius: 5px; /*BORDER-WIDTH-and-RADIUS To 1px/5px*/
                 background-color: transparent; /*BACKGROUND To Transparent*/
