...
rsconnect::deployApp(appDir = paste0(getwd(), "/R/UI_and_SERVER/CLIMINET-SHINYApps"), appName = 'home', appMode = 'shiny', contentCategory = 'site', account = 'climinet', server = 'shinyapps.io')
